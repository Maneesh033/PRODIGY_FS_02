...
// Expose openEditModal to global scope since it's in HTML inline onclick
window.openEditModal = (id) => {
  ...
  document.getElementById('emp-string-id').disabled = true; // prevent changing standard ID
  ...
  document.getElementById('emp-join').value = emp.joining_date.split('T')[0]; // format date
